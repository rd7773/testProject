...
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public void onBindViewHolder(VH viewHolder, int position) {
        ...
        bindViewHolder(viewHolder,position, mCursor);
    }
    ...
    public abstract VH newViewHolder(ViewGroup parent, int viewType);

    public abstract void bindViewHolder(VH viewHolder,int position , Cursor cursor);
